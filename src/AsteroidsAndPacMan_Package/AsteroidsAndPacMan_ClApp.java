    ...
    private void targetBot_ArrLst_Setup_Mth(ArrayList<SpriteCore_ClAb> targetBot_ArrLst) {
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            if( rand.nextBoolean() ){
                ...
                //[jwc] SpriteCore_ClAb targetBotOb = new SpriteCore_ClAb("/AsteroidsAndPacMan_Package/ufo.png", px, py);
                //y- SpriteCore_ClAb targetBotOb = new IconBriefcase_Cl("/AsteroidsAndPacMan_Package/ufo.png", px, py);
